...
import pPrototype from '../assets/media/portfolio/p-prototype.mp4';
import pBowling from '../assets/media/portfolio/p-bowling.mp4';
import pComic from '../assets/media/portfolio/p-comic.mp4';
import pPetrobo from '../assets/media/portfolio/p-petrobo.mp4';
import pEffects from '../assets/media/portfolio/p-effects.mp4';
import pEcommerce from '../assets/media/portfolio/p-ecommerce.mp4';
import pMarker from '../assets/media/portfolio/p-marker.mp4';
